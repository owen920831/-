...
HD_PWD='E:/lab5/fpgaaaa/fpgaaaa.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpga1.tcl -notrace
